...
nl_df %>%
  ...
  geom_vline(xintercept = c(1920, 1947, 1962), 
             colour = "#010210", linetype = "solid", size = 0.5)+
  geom_text(aes(x = 1938.5, y = 111, 
                label = "1947: Jackie Robinson debuts\n for the Brooklyn Dodgers", 
                fontface = "plain"), 
            angle = 0, col = "#010210",
            family = "jost-sans-serif",
            size = 5)+
  geom_text(aes(x = 1912, y = 111, 
                label = "1920: Negro National League\n established",
                fontface = "plain"), angle = 0, col = "#010210",
            family = "jost-sans-serif",
            size = 5)+
  geom_text(aes(x = 1970, y = 111, 
                label = "1962: Negro American League\n folds",
                fontface = "plain"), angle = 0, col = "#010210",
            family = "jost-sans-serif",
            size = 5)
```
```{r, echo=F, message=F, warning=F, fig.height = 11.25, fig.width = 20, fig.align = "center"}
nl_mlb_player_data <- nl_mlb_player_data %>% 
  add_count(year)
...
nl_mlb_player_data %>% 
  ...
  labs(y = "Player Count",
       x = "Year")+
  scale_x_continuous(breaks = c(1947, 1952, 1957, 1962, 
                                1967, 1972, 1977))+
