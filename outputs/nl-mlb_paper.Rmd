...
nl_mlb_counts %>%
  ...
  kableExtra::kbl(caption = 
                    "Negro Leagues Players in MLB - Counts and Proportions, 1947 - 1980: CNLBR and Retrosheet Data.", 
...
```{r nlp-mlb-team-counts, echo=F, message=F, warning=F}
# pipe nl_team_counts
nl_team_counts %>% 
  # select the necessary columns
  select(lastname, firstname, Team, Pos, season, nlp_team_count, player_season_count) %>% 
  # generate table using kbl function from kableExtra
  kableExtra::kbl(caption = "Negro Leagues Players in MLB - Player Counts per MLB Team, 1947 - 1980: CNLBR and Retrosheet Data.", 
                  booktabs = T, 
                  col.names = c("Last Name", "First Name", "Team", 
                                "Position", "Season", "NL Players per Team", "Teams Played For in Season"),
                  longtable = T) %>% 
  kableExtra::kable_styling(position = "center",
                            latex_options = c("HOLD_position",
                                              "repeat_header"),
