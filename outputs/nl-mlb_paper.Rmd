...
```{r histogram-wiki, echo=FALSE, message=F, warning=F, fig.align='center', fig.height=8, fig.width=12, fig.cap="A distribution of the number of players debuting and playing their final game in a given season in the Negro Leagues, 1873 to 1975: Wikipedia Data.."}
# load nl_mlb_playercount plot
...
```{r histogram-seams, echo=FALSE, message=F, warning=F, fig.align='center', fig.height=8, fig.width=12, fig.cap="A distribution of the number of players debuting and playing their final game in a given season in the Negro Leagues, 1887 to 1948: Seamheads Data."}
...
```{r histogram-wiki-filter, echo=FALSE, warning=F, message=F, fig.align='center', fig.cap="A distribution of the number of players debuting and playing their final game in a given season in the Negro Leagues, 1887 to 1948: Wikipedia Data."}
# load nl_mlb_playercount plot
...
```{r wiki-nl-count, echo=FALSE, warning=F, message=F, fig.align='center', fig.height=8, fig.width=12, fig.cap="The estimated distribution of players in the Negro Leagues, 1873 to 1975: Wikipedia data."}
...
```{r seamheads-nl-count, echo=FALSE, message=F, warning=F, fig.align='center', fig.height=8, fig.width=12, fig.cap="The estimated distribution of players in the Negro Leagues, 1886 to 1948: Seamheads data."}
source(here("script/rmarkdown/plots/seamheads_playercounts.R"))
seam_player_counts
```

```{r wiki-nl-count-filter, echo=FALSE, message=F, warning=F, fig.align='center', fig.height=8, fig.width=12, fig.cap="The estimated distribution of players in the Negro Leagues, 1886 to 1948: Wikipedia data."}
...
```{r mlb-debut, echo=FALSE, warning=F, message=F, fig.align='center', fig.height=8, fig.width=12, fig.cap="The number of players debuting for a given season in Major League Baseball who also played in the Negro Leagues.", out.height="50%"}
# load nl_mlb_playercount plot
source(here("script/rmarkdown/plots/nl_mlb_debut_counts.R"))
nl_mlb_debut_counts
```

```{r nl-mlb-player-counts, echo=F, warning=F, message=F, fig.align='center', fig.height=8, fig.width=12, fig.cap="The number of players for a given season in Major League Baseball who also played in the Negro Leagues, 1947 to 1981."}
# load nl_mlb_playercount plot
