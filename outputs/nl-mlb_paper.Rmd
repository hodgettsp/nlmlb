...
```{r histogram, echo=FALSE, fig.align='center', fig.cap="A distribution of the number of players debuting and playing their final game in a given season in the Negro Leagues, 1873 to 1975.", out.height="50%"}
