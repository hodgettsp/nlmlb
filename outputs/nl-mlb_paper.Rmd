...
```{r wiki-nl-count-filter, echo=FALSE, fig.align='center', fig.cap="The estimated distribution of players in the Negro Leagues, 1886 to 1948:.", out.height="50%"}
