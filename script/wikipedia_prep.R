...
nl_player_data <- nl_player_data %>%
     ...
     mutate(nickname = str_extract(player, '\\".*"'),
            ...
            debut = case_when(debut == "19__" & player == "Johnny Washington" ~ "1950",
                              debut == "19__" & player == "Charles Johnson" ~ "1928",
                              debut == "19__" & player == "Martinez Jackson" ~ "1929",
                              debut == "19__" & player == "Harry Chappas" ~ "1975",
                              debut == "19__" & player == "Ike Brown" ~ "1960",
                              debut == "19__" & player == "Marshall Bridges" ~ "1951",
                              debut == "19__" & player == "Walt Bond" ~ "1956",
                              debut == "19__" & player == "Jim Proctor" ~ "1955",
                              debut == "19__" ~ NA_character_,
                              player == "Jesse H. Williams" ~ "1939",
                              TRUE ~ as.character(debut)),
            last_game = case_when(last_game == "19__" & player == "Johnny Washington" ~ "1950",
                                  last_game == "19__" & player == "Charles Johnson" ~ "1941",
                                  last_game == "19__" & player == "Martinez Jackson" ~ "1933",
                                  last_game == "19__" & player == "Harry Chappas" ~ "1975",
                                  last_game == "19__" & player == "Ike Brown" ~ "1961",
                                  last_game == "19__" & player == "Marshall Bridgers" ~ "1954",
                                  last_game == "19__" & player == "Walt Bond" ~ "1956",
                                  last_game == "19__" & player == "Jim Proctor" ~ "1955",
                                  last_game == "19__" ~ NA_character_,
                                  player == "Jesse H.  Williams" ~ "1950",
                                  TRUE ~ as.character(last_game)),
